...
extern(C) @nogc nothrow
{
    ...
    alias da_igDragFloat2 = bool function(const char* label,float[2] v,float v_speed,float v_min,float v_max,const char* format,ImGuiSliderFlags flags);
    alias da_igDragFloat3 = bool function(const char* label,float[3] v,float v_speed,float v_min,float v_max,const char* format,ImGuiSliderFlags flags);
    alias da_igDragFloat4 = bool function(const char* label,float[4] v,float v_speed,float v_min,float v_max,const char* format,ImGuiSliderFlags flags);
    ...
    alias da_igDragInt2 = bool function(const char* label,int[2] v,float v_speed,int v_min,int v_max,const char* format,ImGuiSliderFlags flags);
    alias da_igDragInt3 = bool function(const char* label,int[3] v,float v_speed,int v_min,int v_max,const char* format,ImGuiSliderFlags flags);
    alias da_igDragInt4 = bool function(const char* label,int[4] v,float v_speed,int v_min,int v_max,const char* format,ImGuiSliderFlags flags);
    ...
    alias da_igSliderFloat2 = bool function(const char* label,float[2] v,float v_min,float v_max,const char* format,ImGuiSliderFlags flags);
    alias da_igSliderFloat3 = bool function(const char* label,float[3] v,float v_min,float v_max,const char* format,ImGuiSliderFlags flags);
    alias da_igSliderFloat4 = bool function(const char* label,float[4] v,float v_min,float v_max,const char* format,ImGuiSliderFlags flags);
    ...
    alias da_igSliderInt2 = bool function(const char* label,int[2] v,int v_min,int v_max,const char* format,ImGuiSliderFlags flags);
    alias da_igSliderInt3 = bool function(const char* label,int[3] v,int v_min,int v_max,const char* format,ImGuiSliderFlags flags);
    alias da_igSliderInt4 = bool function(const char* label,int[4] v,int v_min,int v_max,const char* format,ImGuiSliderFlags flags);
