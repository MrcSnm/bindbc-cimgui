...
extern(C)
{
    ...
    struct ImVector_ImDrawCmd
    {
        ...
        ref ImDrawCmd opIndex(int ind){return Data[ind];}
    }
    ...
    alias ImGuiDragDropFlags_ = _Anonymous_14;
    enum _Anonymous_14
    {
    ...
    enum ImGuiDragDropFlags_None = _Anonymous_14.ImGuiDragDropFlags_None;
    enum ImGuiDragDropFlags_SourceNoPreviewTooltip = _Anonymous_14.ImGuiDragDropFlags_SourceNoPreviewTooltip;
    enum ImGuiDragDropFlags_SourceNoDisableHover = _Anonymous_14.ImGuiDragDropFlags_SourceNoDisableHover;
    enum ImGuiDragDropFlags_SourceNoHoldToOpenOthers = _Anonymous_14.ImGuiDragDropFlags_SourceNoHoldToOpenOthers;
    enum ImGuiDragDropFlags_SourceAllowNullID = _Anonymous_14.ImGuiDragDropFlags_SourceAllowNullID;
    enum ImGuiDragDropFlags_SourceExtern = _Anonymous_14.ImGuiDragDropFlags_SourceExtern;
    enum ImGuiDragDropFlags_SourceAutoExpirePayload = _Anonymous_14.ImGuiDragDropFlags_SourceAutoExpirePayload;
    enum ImGuiDragDropFlags_AcceptBeforeDelivery = _Anonymous_14.ImGuiDragDropFlags_AcceptBeforeDelivery;
    enum ImGuiDragDropFlags_AcceptNoDrawDefaultRect = _Anonymous_14.ImGuiDragDropFlags_AcceptNoDrawDefaultRect;
    enum ImGuiDragDropFlags_AcceptNoPreviewTooltip = _Anonymous_14.ImGuiDragDropFlags_AcceptNoPreviewTooltip;
    enum ImGuiDragDropFlags_AcceptPeekOnly = _Anonymous_14.ImGuiDragDropFlags_AcceptPeekOnly;
    alias ImGuiDataType_ = _Anonymous_15;
    enum _Anonymous_15
    {
        ImGuiDataType_S8 = 0,
        ImGuiDataType_U8 = 1,
    ...
    enum ImGuiDataType_S8 = _Anonymous_15.ImGuiDataType_S8;
    enum ImGuiDataType_U8 = _Anonymous_15.ImGuiDataType_U8;
    enum ImGuiDataType_S16 = _Anonymous_15.ImGuiDataType_S16;
    enum ImGuiDataType_U16 = _Anonymous_15.ImGuiDataType_U16;
    enum ImGuiDataType_S32 = _Anonymous_15.ImGuiDataType_S32;
    enum ImGuiDataType_U32 = _Anonymous_15.ImGuiDataType_U32;
    enum ImGuiDataType_S64 = _Anonymous_15.ImGuiDataType_S64;
    enum ImGuiDataType_U64 = _Anonymous_15.ImGuiDataType_U64;
    enum ImGuiDataType_Float = _Anonymous_15.ImGuiDataType_Float;
    enum ImGuiDataType_Double = _Anonymous_15.ImGuiDataType_Double;
    enum ImGuiDataType_COUNT = _Anonymous_15.ImGuiDataType_COUNT;
    alias ImGuiDir_ = _Anonymous_16;
    enum _Anonymous_16
    {
        ImGuiDir_None = -1,
        ImGuiDir_Left = 0,
    ...
    enum ImGuiDir_None = _Anonymous_16.ImGuiDir_None;
    enum ImGuiDir_Left = _Anonymous_16.ImGuiDir_Left;
    enum ImGuiDir_Right = _Anonymous_16.ImGuiDir_Right;
    enum ImGuiDir_Up = _Anonymous_16.ImGuiDir_Up;
    enum ImGuiDir_Down = _Anonymous_16.ImGuiDir_Down;
    enum ImGuiDir_COUNT = _Anonymous_16.ImGuiDir_COUNT;
    alias ImGuiKey_ = _Anonymous_17;
    enum _Anonymous_17
    {
        ImGuiKey_Tab = 0,
    ...
    enum ImGuiKey_Tab = _Anonymous_17.ImGuiKey_Tab;
    enum ImGuiKey_LeftArrow = _Anonymous_17.ImGuiKey_LeftArrow;
    enum ImGuiKey_RightArrow = _Anonymous_17.ImGuiKey_RightArrow;
    enum ImGuiKey_UpArrow = _Anonymous_17.ImGuiKey_UpArrow;
    enum ImGuiKey_DownArrow = _Anonymous_17.ImGuiKey_DownArrow;
    enum ImGuiKey_PageUp = _Anonymous_17.ImGuiKey_PageUp;
    enum ImGuiKey_PageDown = _Anonymous_17.ImGuiKey_PageDown;
    enum ImGuiKey_Home = _Anonymous_17.ImGuiKey_Home;
    enum ImGuiKey_End = _Anonymous_17.ImGuiKey_End;
    enum ImGuiKey_Insert = _Anonymous_17.ImGuiKey_Insert;
    enum ImGuiKey_Delete = _Anonymous_17.ImGuiKey_Delete;
    enum ImGuiKey_Backspace = _Anonymous_17.ImGuiKey_Backspace;
    enum ImGuiKey_Space = _Anonymous_17.ImGuiKey_Space;
    enum ImGuiKey_Enter = _Anonymous_17.ImGuiKey_Enter;
    enum ImGuiKey_Escape = _Anonymous_17.ImGuiKey_Escape;
    enum ImGuiKey_KeyPadEnter = _Anonymous_17.ImGuiKey_KeyPadEnter;
    enum ImGuiKey_A = _Anonymous_17.ImGuiKey_A;
    enum ImGuiKey_C = _Anonymous_17.ImGuiKey_C;
    enum ImGuiKey_V = _Anonymous_17.ImGuiKey_V;
    enum ImGuiKey_X = _Anonymous_17.ImGuiKey_X;
    enum ImGuiKey_Y = _Anonymous_17.ImGuiKey_Y;
    enum ImGuiKey_Z = _Anonymous_17.ImGuiKey_Z;
    enum ImGuiKey_COUNT = _Anonymous_17.ImGuiKey_COUNT;
    alias ImGuiKeyModFlags_ = _Anonymous_18;
    enum _Anonymous_18
    {
    ...
    enum ImGuiKeyModFlags_None = _Anonymous_18.ImGuiKeyModFlags_None;
    enum ImGuiKeyModFlags_Ctrl = _Anonymous_18.ImGuiKeyModFlags_Ctrl;
    enum ImGuiKeyModFlags_Shift = _Anonymous_18.ImGuiKeyModFlags_Shift;
    enum ImGuiKeyModFlags_Alt = _Anonymous_18.ImGuiKeyModFlags_Alt;
    enum ImGuiKeyModFlags_Super = _Anonymous_18.ImGuiKeyModFlags_Super;
    alias ImGuiNavInput_ = _Anonymous_19;
    enum _Anonymous_19
    {
    ...
    enum ImGuiNavInput_Activate = _Anonymous_19.ImGuiNavInput_Activate;
    enum ImGuiNavInput_Cancel = _Anonymous_19.ImGuiNavInput_Cancel;
    enum ImGuiNavInput_Input = _Anonymous_19.ImGuiNavInput_Input;
    enum ImGuiNavInput_Menu = _Anonymous_19.ImGuiNavInput_Menu;
    enum ImGuiNavInput_DpadLeft = _Anonymous_19.ImGuiNavInput_DpadLeft;
    enum ImGuiNavInput_DpadRight = _Anonymous_19.ImGuiNavInput_DpadRight;
    enum ImGuiNavInput_DpadUp = _Anonymous_19.ImGuiNavInput_DpadUp;
    enum ImGuiNavInput_DpadDown = _Anonymous_19.ImGuiNavInput_DpadDown;
    enum ImGuiNavInput_LStickLeft = _Anonymous_19.ImGuiNavInput_LStickLeft;
    enum ImGuiNavInput_LStickRight = _Anonymous_19.ImGuiNavInput_LStickRight;
    enum ImGuiNavInput_LStickUp = _Anonymous_19.ImGuiNavInput_LStickUp;
    enum ImGuiNavInput_LStickDown = _Anonymous_19.ImGuiNavInput_LStickDown;
    enum ImGuiNavInput_FocusPrev = _Anonymous_19.ImGuiNavInput_FocusPrev;
    enum ImGuiNavInput_FocusNext = _Anonymous_19.ImGuiNavInput_FocusNext;
    enum ImGuiNavInput_TweakSlow = _Anonymous_19.ImGuiNavInput_TweakSlow;
    enum ImGuiNavInput_TweakFast = _Anonymous_19.ImGuiNavInput_TweakFast;
    enum ImGuiNavInput_KeyMenu_ = _Anonymous_19.ImGuiNavInput_KeyMenu_;
    enum ImGuiNavInput_KeyLeft_ = _Anonymous_19.ImGuiNavInput_KeyLeft_;
    enum ImGuiNavInput_KeyRight_ = _Anonymous_19.ImGuiNavInput_KeyRight_;
    enum ImGuiNavInput_KeyUp_ = _Anonymous_19.ImGuiNavInput_KeyUp_;
    enum ImGuiNavInput_KeyDown_ = _Anonymous_19.ImGuiNavInput_KeyDown_;
    enum ImGuiNavInput_COUNT = _Anonymous_19.ImGuiNavInput_COUNT;
    enum ImGuiNavInput_InternalStart_ = _Anonymous_19.ImGuiNavInput_InternalStart_;
    alias ImGuiConfigFlags_ = _Anonymous_20;
    enum _Anonymous_20
    {
    ...
    enum ImGuiConfigFlags_None = _Anonymous_20.ImGuiConfigFlags_None;
    enum ImGuiConfigFlags_NavEnableKeyboard = _Anonymous_20.ImGuiConfigFlags_NavEnableKeyboard;
    enum ImGuiConfigFlags_NavEnableGamepad = _Anonymous_20.ImGuiConfigFlags_NavEnableGamepad;
    enum ImGuiConfigFlags_NavEnableSetMousePos = _Anonymous_20.ImGuiConfigFlags_NavEnableSetMousePos;
    enum ImGuiConfigFlags_NavNoCaptureKeyboard = _Anonymous_20.ImGuiConfigFlags_NavNoCaptureKeyboard;
    enum ImGuiConfigFlags_NoMouse = _Anonymous_20.ImGuiConfigFlags_NoMouse;
    enum ImGuiConfigFlags_NoMouseCursorChange = _Anonymous_20.ImGuiConfigFlags_NoMouseCursorChange;
    enum ImGuiConfigFlags_IsSRGB = _Anonymous_20.ImGuiConfigFlags_IsSRGB;
    enum ImGuiConfigFlags_IsTouchScreen = _Anonymous_20.ImGuiConfigFlags_IsTouchScreen;
    alias ImGuiBackendFlags_ = _Anonymous_21;
    enum _Anonymous_21
    {
    ...
    enum ImGuiBackendFlags_None = _Anonymous_21.ImGuiBackendFlags_None;
    enum ImGuiBackendFlags_HasGamepad = _Anonymous_21.ImGuiBackendFlags_HasGamepad;
    enum ImGuiBackendFlags_HasMouseCursors = _Anonymous_21.ImGuiBackendFlags_HasMouseCursors;
    enum ImGuiBackendFlags_HasSetMousePos = _Anonymous_21.ImGuiBackendFlags_HasSetMousePos;
    enum ImGuiBackendFlags_RendererHasVtxOffset = _Anonymous_21.ImGuiBackendFlags_RendererHasVtxOffset;
    alias ImGuiCol_ = _Anonymous_22;
    enum _Anonymous_22
    {
        ImGuiCol_Text = 0,
    ...
    enum ImGuiCol_Text = _Anonymous_22.ImGuiCol_Text;
    enum ImGuiCol_TextDisabled = _Anonymous_22.ImGuiCol_TextDisabled;
    enum ImGuiCol_WindowBg = _Anonymous_22.ImGuiCol_WindowBg;
    enum ImGuiCol_ChildBg = _Anonymous_22.ImGuiCol_ChildBg;
    enum ImGuiCol_PopupBg = _Anonymous_22.ImGuiCol_PopupBg;
    enum ImGuiCol_Border = _Anonymous_22.ImGuiCol_Border;
    enum ImGuiCol_BorderShadow = _Anonymous_22.ImGuiCol_BorderShadow;
    enum ImGuiCol_FrameBg = _Anonymous_22.ImGuiCol_FrameBg;
    enum ImGuiCol_FrameBgHovered = _Anonymous_22.ImGuiCol_FrameBgHovered;
    enum ImGuiCol_FrameBgActive = _Anonymous_22.ImGuiCol_FrameBgActive;
    enum ImGuiCol_TitleBg = _Anonymous_22.ImGuiCol_TitleBg;
    enum ImGuiCol_TitleBgActive = _Anonymous_22.ImGuiCol_TitleBgActive;
    enum ImGuiCol_TitleBgCollapsed = _Anonymous_22.ImGuiCol_TitleBgCollapsed;
    enum ImGuiCol_MenuBarBg = _Anonymous_22.ImGuiCol_MenuBarBg;
    enum ImGuiCol_ScrollbarBg = _Anonymous_22.ImGuiCol_ScrollbarBg;
    enum ImGuiCol_ScrollbarGrab = _Anonymous_22.ImGuiCol_ScrollbarGrab;
    enum ImGuiCol_ScrollbarGrabHovered = _Anonymous_22.ImGuiCol_ScrollbarGrabHovered;
    enum ImGuiCol_ScrollbarGrabActive = _Anonymous_22.ImGuiCol_ScrollbarGrabActive;
    enum ImGuiCol_CheckMark = _Anonymous_22.ImGuiCol_CheckMark;
    enum ImGuiCol_SliderGrab = _Anonymous_22.ImGuiCol_SliderGrab;
    enum ImGuiCol_SliderGrabActive = _Anonymous_22.ImGuiCol_SliderGrabActive;
    enum ImGuiCol_Button = _Anonymous_22.ImGuiCol_Button;
    enum ImGuiCol_ButtonHovered = _Anonymous_22.ImGuiCol_ButtonHovered;
    enum ImGuiCol_ButtonActive = _Anonymous_22.ImGuiCol_ButtonActive;
    enum ImGuiCol_Header = _Anonymous_22.ImGuiCol_Header;
    enum ImGuiCol_HeaderHovered = _Anonymous_22.ImGuiCol_HeaderHovered;
    enum ImGuiCol_HeaderActive = _Anonymous_22.ImGuiCol_HeaderActive;
    enum ImGuiCol_Separator = _Anonymous_22.ImGuiCol_Separator;
    enum ImGuiCol_SeparatorHovered = _Anonymous_22.ImGuiCol_SeparatorHovered;
    enum ImGuiCol_SeparatorActive = _Anonymous_22.ImGuiCol_SeparatorActive;
    enum ImGuiCol_ResizeGrip = _Anonymous_22.ImGuiCol_ResizeGrip;
    enum ImGuiCol_ResizeGripHovered = _Anonymous_22.ImGuiCol_ResizeGripHovered;
    enum ImGuiCol_ResizeGripActive = _Anonymous_22.ImGuiCol_ResizeGripActive;
    enum ImGuiCol_Tab = _Anonymous_22.ImGuiCol_Tab;
    enum ImGuiCol_TabHovered = _Anonymous_22.ImGuiCol_TabHovered;
    enum ImGuiCol_TabActive = _Anonymous_22.ImGuiCol_TabActive;
    enum ImGuiCol_TabUnfocused = _Anonymous_22.ImGuiCol_TabUnfocused;
    enum ImGuiCol_TabUnfocusedActive = _Anonymous_22.ImGuiCol_TabUnfocusedActive;
    enum ImGuiCol_PlotLines = _Anonymous_22.ImGuiCol_PlotLines;
    enum ImGuiCol_PlotLinesHovered = _Anonymous_22.ImGuiCol_PlotLinesHovered;
    enum ImGuiCol_PlotHistogram = _Anonymous_22.ImGuiCol_PlotHistogram;
    enum ImGuiCol_PlotHistogramHovered = _Anonymous_22.ImGuiCol_PlotHistogramHovered;
    enum ImGuiCol_TextSelectedBg = _Anonymous_22.ImGuiCol_TextSelectedBg;
    enum ImGuiCol_DragDropTarget = _Anonymous_22.ImGuiCol_DragDropTarget;
    enum ImGuiCol_NavHighlight = _Anonymous_22.ImGuiCol_NavHighlight;
    enum ImGuiCol_NavWindowingHighlight = _Anonymous_22.ImGuiCol_NavWindowingHighlight;
    enum ImGuiCol_NavWindowingDimBg = _Anonymous_22.ImGuiCol_NavWindowingDimBg;
    enum ImGuiCol_ModalWindowDimBg = _Anonymous_22.ImGuiCol_ModalWindowDimBg;
    enum ImGuiCol_COUNT = _Anonymous_22.ImGuiCol_COUNT;
    alias ImGuiStyleVar_ = _Anonymous_23;
    enum _Anonymous_23
    {
    ...
    enum ImGuiStyleVar_Alpha = _Anonymous_23.ImGuiStyleVar_Alpha;
    enum ImGuiStyleVar_WindowPadding = _Anonymous_23.ImGuiStyleVar_WindowPadding;
    enum ImGuiStyleVar_WindowRounding = _Anonymous_23.ImGuiStyleVar_WindowRounding;
    enum ImGuiStyleVar_WindowBorderSize = _Anonymous_23.ImGuiStyleVar_WindowBorderSize;
    enum ImGuiStyleVar_WindowMinSize = _Anonymous_23.ImGuiStyleVar_WindowMinSize;
    enum ImGuiStyleVar_WindowTitleAlign = _Anonymous_23.ImGuiStyleVar_WindowTitleAlign;
    enum ImGuiStyleVar_ChildRounding = _Anonymous_23.ImGuiStyleVar_ChildRounding;
    enum ImGuiStyleVar_ChildBorderSize = _Anonymous_23.ImGuiStyleVar_ChildBorderSize;
    enum ImGuiStyleVar_PopupRounding = _Anonymous_23.ImGuiStyleVar_PopupRounding;
    enum ImGuiStyleVar_PopupBorderSize = _Anonymous_23.ImGuiStyleVar_PopupBorderSize;
    enum ImGuiStyleVar_FramePadding = _Anonymous_23.ImGuiStyleVar_FramePadding;
    enum ImGuiStyleVar_FrameRounding = _Anonymous_23.ImGuiStyleVar_FrameRounding;
    enum ImGuiStyleVar_FrameBorderSize = _Anonymous_23.ImGuiStyleVar_FrameBorderSize;
    enum ImGuiStyleVar_ItemSpacing = _Anonymous_23.ImGuiStyleVar_ItemSpacing;
    enum ImGuiStyleVar_ItemInnerSpacing = _Anonymous_23.ImGuiStyleVar_ItemInnerSpacing;
    enum ImGuiStyleVar_IndentSpacing = _Anonymous_23.ImGuiStyleVar_IndentSpacing;
    enum ImGuiStyleVar_ScrollbarSize = _Anonymous_23.ImGuiStyleVar_ScrollbarSize;
    enum ImGuiStyleVar_ScrollbarRounding = _Anonymous_23.ImGuiStyleVar_ScrollbarRounding;
    enum ImGuiStyleVar_GrabMinSize = _Anonymous_23.ImGuiStyleVar_GrabMinSize;
    enum ImGuiStyleVar_GrabRounding = _Anonymous_23.ImGuiStyleVar_GrabRounding;
    enum ImGuiStyleVar_TabRounding = _Anonymous_23.ImGuiStyleVar_TabRounding;
    enum ImGuiStyleVar_ButtonTextAlign = _Anonymous_23.ImGuiStyleVar_ButtonTextAlign;
    enum ImGuiStyleVar_SelectableTextAlign = _Anonymous_23.ImGuiStyleVar_SelectableTextAlign;
    enum ImGuiStyleVar_COUNT = _Anonymous_23.ImGuiStyleVar_COUNT;
    alias ImGuiButtonFlags_ = _Anonymous_24;
    enum _Anonymous_24
    {
    ...
    enum ImGuiButtonFlags_None = _Anonymous_24.ImGuiButtonFlags_None;
    enum ImGuiButtonFlags_MouseButtonLeft = _Anonymous_24.ImGuiButtonFlags_MouseButtonLeft;
    enum ImGuiButtonFlags_MouseButtonRight = _Anonymous_24.ImGuiButtonFlags_MouseButtonRight;
    enum ImGuiButtonFlags_MouseButtonMiddle = _Anonymous_24.ImGuiButtonFlags_MouseButtonMiddle;
    enum ImGuiButtonFlags_MouseButtonMask_ = _Anonymous_24.ImGuiButtonFlags_MouseButtonMask_;
    enum ImGuiButtonFlags_MouseButtonDefault_ = _Anonymous_24.ImGuiButtonFlags_MouseButtonDefault_;
    alias ImGuiColorEditFlags_ = _Anonymous_25;
    enum _Anonymous_25
    {
    ...
    enum ImGuiColorEditFlags_None = _Anonymous_25.ImGuiColorEditFlags_None;
    enum ImGuiColorEditFlags_NoAlpha = _Anonymous_25.ImGuiColorEditFlags_NoAlpha;
    enum ImGuiColorEditFlags_NoPicker = _Anonymous_25.ImGuiColorEditFlags_NoPicker;
    enum ImGuiColorEditFlags_NoOptions = _Anonymous_25.ImGuiColorEditFlags_NoOptions;
    enum ImGuiColorEditFlags_NoSmallPreview = _Anonymous_25.ImGuiColorEditFlags_NoSmallPreview;
    enum ImGuiColorEditFlags_NoInputs = _Anonymous_25.ImGuiColorEditFlags_NoInputs;
    enum ImGuiColorEditFlags_NoTooltip = _Anonymous_25.ImGuiColorEditFlags_NoTooltip;
    enum ImGuiColorEditFlags_NoLabel = _Anonymous_25.ImGuiColorEditFlags_NoLabel;
    enum ImGuiColorEditFlags_NoSidePreview = _Anonymous_25.ImGuiColorEditFlags_NoSidePreview;
    enum ImGuiColorEditFlags_NoDragDrop = _Anonymous_25.ImGuiColorEditFlags_NoDragDrop;
    enum ImGuiColorEditFlags_NoBorder = _Anonymous_25.ImGuiColorEditFlags_NoBorder;
    enum ImGuiColorEditFlags_AlphaBar = _Anonymous_25.ImGuiColorEditFlags_AlphaBar;
    enum ImGuiColorEditFlags_AlphaPreview = _Anonymous_25.ImGuiColorEditFlags_AlphaPreview;
    enum ImGuiColorEditFlags_AlphaPreviewHalf = _Anonymous_25.ImGuiColorEditFlags_AlphaPreviewHalf;
    enum ImGuiColorEditFlags_HDR = _Anonymous_25.ImGuiColorEditFlags_HDR;
    enum ImGuiColorEditFlags_DisplayRGB = _Anonymous_25.ImGuiColorEditFlags_DisplayRGB;
    enum ImGuiColorEditFlags_DisplayHSV = _Anonymous_25.ImGuiColorEditFlags_DisplayHSV;
    enum ImGuiColorEditFlags_DisplayHex = _Anonymous_25.ImGuiColorEditFlags_DisplayHex;
    enum ImGuiColorEditFlags_Uint8 = _Anonymous_25.ImGuiColorEditFlags_Uint8;
    enum ImGuiColorEditFlags_Float = _Anonymous_25.ImGuiColorEditFlags_Float;
    enum ImGuiColorEditFlags_PickerHueBar = _Anonymous_25.ImGuiColorEditFlags_PickerHueBar;
    enum ImGuiColorEditFlags_PickerHueWheel = _Anonymous_25.ImGuiColorEditFlags_PickerHueWheel;
    enum ImGuiColorEditFlags_InputRGB = _Anonymous_25.ImGuiColorEditFlags_InputRGB;
    enum ImGuiColorEditFlags_InputHSV = _Anonymous_25.ImGuiColorEditFlags_InputHSV;
    enum ImGuiColorEditFlags__OptionsDefault = _Anonymous_25.ImGuiColorEditFlags__OptionsDefault;
    enum ImGuiColorEditFlags__DisplayMask = _Anonymous_25.ImGuiColorEditFlags__DisplayMask;
    enum ImGuiColorEditFlags__DataTypeMask = _Anonymous_25.ImGuiColorEditFlags__DataTypeMask;
    enum ImGuiColorEditFlags__PickerMask = _Anonymous_25.ImGuiColorEditFlags__PickerMask;
    enum ImGuiColorEditFlags__InputMask = _Anonymous_25.ImGuiColorEditFlags__InputMask;
    alias ImGuiSliderFlags_ = _Anonymous_26;
    enum _Anonymous_26
    {
    ...
    enum ImGuiSliderFlags_None = _Anonymous_26.ImGuiSliderFlags_None;
    enum ImGuiSliderFlags_ClampOnInput = _Anonymous_26.ImGuiSliderFlags_ClampOnInput;
    enum ImGuiSliderFlags_Logarithmic = _Anonymous_26.ImGuiSliderFlags_Logarithmic;
    enum ImGuiSliderFlags_NoRoundToFormat = _Anonymous_26.ImGuiSliderFlags_NoRoundToFormat;
    enum ImGuiSliderFlags_NoInput = _Anonymous_26.ImGuiSliderFlags_NoInput;
    enum ImGuiSliderFlags_InvalidMask_ = _Anonymous_26.ImGuiSliderFlags_InvalidMask_;
    alias ImGuiMouseButton_ = _Anonymous_27;
    enum _Anonymous_27
    {
    ...
    enum ImGuiMouseButton_Left = _Anonymous_27.ImGuiMouseButton_Left;
    enum ImGuiMouseButton_Right = _Anonymous_27.ImGuiMouseButton_Right;
    enum ImGuiMouseButton_Middle = _Anonymous_27.ImGuiMouseButton_Middle;
    enum ImGuiMouseButton_COUNT = _Anonymous_27.ImGuiMouseButton_COUNT;
    alias ImGuiMouseCursor_ = _Anonymous_28;
    enum _Anonymous_28
    {
    ...
    enum ImGuiMouseCursor_None = _Anonymous_28.ImGuiMouseCursor_None;
    enum ImGuiMouseCursor_Arrow = _Anonymous_28.ImGuiMouseCursor_Arrow;
    enum ImGuiMouseCursor_TextInput = _Anonymous_28.ImGuiMouseCursor_TextInput;
    enum ImGuiMouseCursor_ResizeAll = _Anonymous_28.ImGuiMouseCursor_ResizeAll;
    enum ImGuiMouseCursor_ResizeNS = _Anonymous_28.ImGuiMouseCursor_ResizeNS;
    enum ImGuiMouseCursor_ResizeEW = _Anonymous_28.ImGuiMouseCursor_ResizeEW;
    enum ImGuiMouseCursor_ResizeNESW = _Anonymous_28.ImGuiMouseCursor_ResizeNESW;
    enum ImGuiMouseCursor_ResizeNWSE = _Anonymous_28.ImGuiMouseCursor_ResizeNWSE;
    enum ImGuiMouseCursor_Hand = _Anonymous_28.ImGuiMouseCursor_Hand;
    enum ImGuiMouseCursor_NotAllowed = _Anonymous_28.ImGuiMouseCursor_NotAllowed;
    enum ImGuiMouseCursor_COUNT = _Anonymous_28.ImGuiMouseCursor_COUNT;
    alias ImGuiCond_ = _Anonymous_29;
    enum _Anonymous_29
    {
        ImGuiCond_None = 0,
        ImGuiCond_Always = 1,
    ...
    enum ImGuiCond_None = _Anonymous_29.ImGuiCond_None;
    enum ImGuiCond_Always = _Anonymous_29.ImGuiCond_Always;
    enum ImGuiCond_Once = _Anonymous_29.ImGuiCond_Once;
    enum ImGuiCond_FirstUseEver = _Anonymous_29.ImGuiCond_FirstUseEver;
    enum ImGuiCond_Appearing = _Anonymous_29.ImGuiCond_Appearing;
    ...
    alias ImDrawCornerFlags_ = _Anonymous_30;
    enum _Anonymous_30
    {
    ...
    enum ImDrawCornerFlags_None = _Anonymous_30.ImDrawCornerFlags_None;
    enum ImDrawCornerFlags_TopLeft = _Anonymous_30.ImDrawCornerFlags_TopLeft;
    enum ImDrawCornerFlags_TopRight = _Anonymous_30.ImDrawCornerFlags_TopRight;
    enum ImDrawCornerFlags_BotLeft = _Anonymous_30.ImDrawCornerFlags_BotLeft;
    enum ImDrawCornerFlags_BotRight = _Anonymous_30.ImDrawCornerFlags_BotRight;
    enum ImDrawCornerFlags_Top = _Anonymous_30.ImDrawCornerFlags_Top;
    enum ImDrawCornerFlags_Bot = _Anonymous_30.ImDrawCornerFlags_Bot;
    enum ImDrawCornerFlags_Left = _Anonymous_30.ImDrawCornerFlags_Left;
    enum ImDrawCornerFlags_Right = _Anonymous_30.ImDrawCornerFlags_Right;
    enum ImDrawCornerFlags_All = _Anonymous_30.ImDrawCornerFlags_All;
    alias ImDrawListFlags_ = _Anonymous_31;
    enum _Anonymous_31
    {
    ...
    enum ImDrawListFlags_None = _Anonymous_31.ImDrawListFlags_None;
    enum ImDrawListFlags_AntiAliasedLines = _Anonymous_31.ImDrawListFlags_AntiAliasedLines;
    enum ImDrawListFlags_AntiAliasedLinesUseTex = _Anonymous_31.ImDrawListFlags_AntiAliasedLinesUseTex;
    enum ImDrawListFlags_AntiAliasedFill = _Anonymous_31.ImDrawListFlags_AntiAliasedFill;
    enum ImDrawListFlags_AllowVtxOffset = _Anonymous_31.ImDrawListFlags_AllowVtxOffset;
    alias ImFontAtlasFlags_ = _Anonymous_32;
    enum _Anonymous_32
    {
    ...
    enum ImFontAtlasFlags_None = _Anonymous_32.ImFontAtlasFlags_None;
    enum ImFontAtlasFlags_NoPowerOfTwoHeight = _Anonymous_32.ImFontAtlasFlags_NoPowerOfTwoHeight;
    enum ImFontAtlasFlags_NoMouseCursors = _Anonymous_32.ImFontAtlasFlags_NoMouseCursors;
    enum ImFontAtlasFlags_NoBakedLines = _Anonymous_32.ImFontAtlasFlags_NoBakedLines;
    alias ImGuiItemFlags_ = _Anonymous_33;
    enum _Anonymous_33
    {
    ...
    enum ImGuiItemFlags_None = _Anonymous_33.ImGuiItemFlags_None;
    enum ImGuiItemFlags_NoTabStop = _Anonymous_33.ImGuiItemFlags_NoTabStop;
    enum ImGuiItemFlags_ButtonRepeat = _Anonymous_33.ImGuiItemFlags_ButtonRepeat;
    enum ImGuiItemFlags_Disabled = _Anonymous_33.ImGuiItemFlags_Disabled;
    enum ImGuiItemFlags_NoNav = _Anonymous_33.ImGuiItemFlags_NoNav;
    enum ImGuiItemFlags_NoNavDefaultFocus = _Anonymous_33.ImGuiItemFlags_NoNavDefaultFocus;
    enum ImGuiItemFlags_SelectableDontClosePopup = _Anonymous_33.ImGuiItemFlags_SelectableDontClosePopup;
    enum ImGuiItemFlags_MixedValue = _Anonymous_33.ImGuiItemFlags_MixedValue;
    enum ImGuiItemFlags_ReadOnly = _Anonymous_33.ImGuiItemFlags_ReadOnly;
    enum ImGuiItemFlags_Default_ = _Anonymous_33.ImGuiItemFlags_Default_;
    alias ImGuiItemStatusFlags_ = _Anonymous_34;
    enum _Anonymous_34
    {
    ...
    enum ImGuiItemStatusFlags_None = _Anonymous_34.ImGuiItemStatusFlags_None;
    enum ImGuiItemStatusFlags_HoveredRect = _Anonymous_34.ImGuiItemStatusFlags_HoveredRect;
    enum ImGuiItemStatusFlags_HasDisplayRect = _Anonymous_34.ImGuiItemStatusFlags_HasDisplayRect;
    enum ImGuiItemStatusFlags_Edited = _Anonymous_34.ImGuiItemStatusFlags_Edited;
    enum ImGuiItemStatusFlags_ToggledSelection = _Anonymous_34.ImGuiItemStatusFlags_ToggledSelection;
    enum ImGuiItemStatusFlags_ToggledOpen = _Anonymous_34.ImGuiItemStatusFlags_ToggledOpen;
    enum ImGuiItemStatusFlags_HasDeactivated = _Anonymous_34.ImGuiItemStatusFlags_HasDeactivated;
    enum ImGuiItemStatusFlags_Deactivated = _Anonymous_34.ImGuiItemStatusFlags_Deactivated;
    alias ImGuiButtonFlagsPrivate_ = _Anonymous_35;
    enum _Anonymous_35
    {
    ...
    enum ImGuiButtonFlags_PressedOnClick = _Anonymous_35.ImGuiButtonFlags_PressedOnClick;
    enum ImGuiButtonFlags_PressedOnClickRelease = _Anonymous_35.ImGuiButtonFlags_PressedOnClickRelease;
    enum ImGuiButtonFlags_PressedOnClickReleaseAnywhere = _Anonymous_35.ImGuiButtonFlags_PressedOnClickReleaseAnywhere;
    enum ImGuiButtonFlags_PressedOnRelease = _Anonymous_35.ImGuiButtonFlags_PressedOnRelease;
    enum ImGuiButtonFlags_PressedOnDoubleClick = _Anonymous_35.ImGuiButtonFlags_PressedOnDoubleClick;
    enum ImGuiButtonFlags_PressedOnDragDropHold = _Anonymous_35.ImGuiButtonFlags_PressedOnDragDropHold;
    enum ImGuiButtonFlags_Repeat = _Anonymous_35.ImGuiButtonFlags_Repeat;
    enum ImGuiButtonFlags_FlattenChildren = _Anonymous_35.ImGuiButtonFlags_FlattenChildren;
    enum ImGuiButtonFlags_AllowItemOverlap = _Anonymous_35.ImGuiButtonFlags_AllowItemOverlap;
    enum ImGuiButtonFlags_DontClosePopups = _Anonymous_35.ImGuiButtonFlags_DontClosePopups;
    enum ImGuiButtonFlags_Disabled = _Anonymous_35.ImGuiButtonFlags_Disabled;
    enum ImGuiButtonFlags_AlignTextBaseLine = _Anonymous_35.ImGuiButtonFlags_AlignTextBaseLine;
    enum ImGuiButtonFlags_NoKeyModifiers = _Anonymous_35.ImGuiButtonFlags_NoKeyModifiers;
    enum ImGuiButtonFlags_NoHoldingActiveId = _Anonymous_35.ImGuiButtonFlags_NoHoldingActiveId;
    enum ImGuiButtonFlags_NoNavFocus = _Anonymous_35.ImGuiButtonFlags_NoNavFocus;
    enum ImGuiButtonFlags_NoHoveredOnFocus = _Anonymous_35.ImGuiButtonFlags_NoHoveredOnFocus;
    enum ImGuiButtonFlags_PressedOnMask_ = _Anonymous_35.ImGuiButtonFlags_PressedOnMask_;
    enum ImGuiButtonFlags_PressedOnDefault_ = _Anonymous_35.ImGuiButtonFlags_PressedOnDefault_;
    alias ImGuiSliderFlagsPrivate_ = _Anonymous_36;
    enum _Anonymous_36
    {
        ImGuiSliderFlags_Vertical = 1048576,
        ImGuiSliderFlags_ReadOnly = 2097152,
    }
    enum ImGuiSliderFlags_Vertical = _Anonymous_36.ImGuiSliderFlags_Vertical;
    enum ImGuiSliderFlags_ReadOnly = _Anonymous_36.ImGuiSliderFlags_ReadOnly;
    alias ImGuiSelectableFlagsPrivate_ = _Anonymous_37;
    enum _Anonymous_37
    {
    ...
    enum ImGuiSelectableFlags_NoHoldingActiveID = _Anonymous_37.ImGuiSelectableFlags_NoHoldingActiveID;
    enum ImGuiSelectableFlags_SelectOnClick = _Anonymous_37.ImGuiSelectableFlags_SelectOnClick;
    enum ImGuiSelectableFlags_SelectOnRelease = _Anonymous_37.ImGuiSelectableFlags_SelectOnRelease;
    enum ImGuiSelectableFlags_SpanAvailWidth = _Anonymous_37.ImGuiSelectableFlags_SpanAvailWidth;
    enum ImGuiSelectableFlags_DrawHoveredWhenHeld = _Anonymous_37.ImGuiSelectableFlags_DrawHoveredWhenHeld;
    enum ImGuiSelectableFlags_SetNavIdOnHover = _Anonymous_37.ImGuiSelectableFlags_SetNavIdOnHover;
    alias ImGuiTreeNodeFlagsPrivate_ = _Anonymous_38;
    enum _Anonymous_38
    {
        ImGuiTreeNodeFlags_ClipLabelForTrailingButton = 1048576,
    }
    enum ImGuiTreeNodeFlags_ClipLabelForTrailingButton = _Anonymous_38.ImGuiTreeNodeFlags_ClipLabelForTrailingButton;
    alias ImGuiSeparatorFlags_ = _Anonymous_39;
    enum _Anonymous_39
    {
    ...
    enum ImGuiSeparatorFlags_None = _Anonymous_39.ImGuiSeparatorFlags_None;
    enum ImGuiSeparatorFlags_Horizontal = _Anonymous_39.ImGuiSeparatorFlags_Horizontal;
    enum ImGuiSeparatorFlags_Vertical = _Anonymous_39.ImGuiSeparatorFlags_Vertical;
    enum ImGuiSeparatorFlags_SpanAllColumns = _Anonymous_39.ImGuiSeparatorFlags_SpanAllColumns;
    alias ImGuiTextFlags_ = _Anonymous_40;
    enum _Anonymous_40
    {
        ImGuiTextFlags_None = 0,
        ImGuiTextFlags_NoWidthForLargeClippedText = 1,
    }
    enum ImGuiTextFlags_None = _Anonymous_40.ImGuiTextFlags_None;
    enum ImGuiTextFlags_NoWidthForLargeClippedText = _Anonymous_40.ImGuiTextFlags_NoWidthForLargeClippedText;
    alias ImGuiTooltipFlags_ = _Anonymous_41;
    enum _Anonymous_41
    {
        ImGuiTooltipFlags_None = 0,
        ImGuiTooltipFlags_OverridePreviousTooltip = 1,
    }
    enum ImGuiTooltipFlags_None = _Anonymous_41.ImGuiTooltipFlags_None;
    enum ImGuiTooltipFlags_OverridePreviousTooltip = _Anonymous_41.ImGuiTooltipFlags_OverridePreviousTooltip;
    alias ImGuiLayoutType_ = _Anonymous_42;
    enum _Anonymous_42
    {
        ImGuiLayoutType_Horizontal = 0,
        ImGuiLayoutType_Vertical = 1,
    }
    enum ImGuiLayoutType_Horizontal = _Anonymous_42.ImGuiLayoutType_Horizontal;
    enum ImGuiLayoutType_Vertical = _Anonymous_42.ImGuiLayoutType_Vertical;
    alias ImGuiLogType = _Anonymous_43;
    enum _Anonymous_43
    {
        ImGuiLogType_None = 0,
        ImGuiLogType_TTY = 1,
    ...
    enum ImGuiLogType_None = _Anonymous_43.ImGuiLogType_None;
    enum ImGuiLogType_TTY = _Anonymous_43.ImGuiLogType_TTY;
    enum ImGuiLogType_File = _Anonymous_43.ImGuiLogType_File;
    enum ImGuiLogType_Buffer = _Anonymous_43.ImGuiLogType_Buffer;
    enum ImGuiLogType_Clipboard = _Anonymous_43.ImGuiLogType_Clipboard;
    alias ImGuiAxis = _Anonymous_44;
    enum _Anonymous_44
    {
        ImGuiAxis_None = -1,
        ImGuiAxis_X = 0,
    ...
    enum ImGuiAxis_None = _Anonymous_44.ImGuiAxis_None;
    enum ImGuiAxis_X = _Anonymous_44.ImGuiAxis_X;
    enum ImGuiAxis_Y = _Anonymous_44.ImGuiAxis_Y;
    alias ImGuiPlotType = _Anonymous_45;
    enum _Anonymous_45
    {
        ImGuiPlotType_Lines = 0,
        ImGuiPlotType_Histogram = 1,
    }
    enum ImGuiPlotType_Lines = _Anonymous_45.ImGuiPlotType_Lines;
    enum ImGuiPlotType_Histogram = _Anonymous_45.ImGuiPlotType_Histogram;
    alias ImGuiInputSource = _Anonymous_46;
    enum _Anonymous_46
    {
    ...
    enum ImGuiInputSource_None = _Anonymous_46.ImGuiInputSource_None;
    enum ImGuiInputSource_Mouse = _Anonymous_46.ImGuiInputSource_Mouse;
    enum ImGuiInputSource_Nav = _Anonymous_46.ImGuiInputSource_Nav;
    enum ImGuiInputSource_NavKeyboard = _Anonymous_46.ImGuiInputSource_NavKeyboard;
    enum ImGuiInputSource_NavGamepad = _Anonymous_46.ImGuiInputSource_NavGamepad;
    enum ImGuiInputSource_COUNT = _Anonymous_46.ImGuiInputSource_COUNT;
    alias ImGuiInputReadMode = _Anonymous_47;
    enum _Anonymous_47
    {
    ...
    enum ImGuiInputReadMode_Down = _Anonymous_47.ImGuiInputReadMode_Down;
    enum ImGuiInputReadMode_Pressed = _Anonymous_47.ImGuiInputReadMode_Pressed;
    enum ImGuiInputReadMode_Released = _Anonymous_47.ImGuiInputReadMode_Released;
    enum ImGuiInputReadMode_Repeat = _Anonymous_47.ImGuiInputReadMode_Repeat;
    enum ImGuiInputReadMode_RepeatSlow = _Anonymous_47.ImGuiInputReadMode_RepeatSlow;
    enum ImGuiInputReadMode_RepeatFast = _Anonymous_47.ImGuiInputReadMode_RepeatFast;
    alias ImGuiNavHighlightFlags_ = _Anonymous_48;
    enum _Anonymous_48
    {
    ...
    enum ImGuiNavHighlightFlags_None = _Anonymous_48.ImGuiNavHighlightFlags_None;
    enum ImGuiNavHighlightFlags_TypeDefault = _Anonymous_48.ImGuiNavHighlightFlags_TypeDefault;
    enum ImGuiNavHighlightFlags_TypeThin = _Anonymous_48.ImGuiNavHighlightFlags_TypeThin;
    enum ImGuiNavHighlightFlags_AlwaysDraw = _Anonymous_48.ImGuiNavHighlightFlags_AlwaysDraw;
    enum ImGuiNavHighlightFlags_NoRounding = _Anonymous_48.ImGuiNavHighlightFlags_NoRounding;
    alias ImGuiNavDirSourceFlags_ = _Anonymous_49;
    enum _Anonymous_49
    {
    ...
    enum ImGuiNavDirSourceFlags_None = _Anonymous_49.ImGuiNavDirSourceFlags_None;
    enum ImGuiNavDirSourceFlags_Keyboard = _Anonymous_49.ImGuiNavDirSourceFlags_Keyboard;
    enum ImGuiNavDirSourceFlags_PadDPad = _Anonymous_49.ImGuiNavDirSourceFlags_PadDPad;
    enum ImGuiNavDirSourceFlags_PadLStick = _Anonymous_49.ImGuiNavDirSourceFlags_PadLStick;
    alias ImGuiNavMoveFlags_ = _Anonymous_50;
    enum _Anonymous_50
    {
    ...
    enum ImGuiNavMoveFlags_None = _Anonymous_50.ImGuiNavMoveFlags_None;
    enum ImGuiNavMoveFlags_LoopX = _Anonymous_50.ImGuiNavMoveFlags_LoopX;
    enum ImGuiNavMoveFlags_LoopY = _Anonymous_50.ImGuiNavMoveFlags_LoopY;
    enum ImGuiNavMoveFlags_WrapX = _Anonymous_50.ImGuiNavMoveFlags_WrapX;
    enum ImGuiNavMoveFlags_WrapY = _Anonymous_50.ImGuiNavMoveFlags_WrapY;
    enum ImGuiNavMoveFlags_AllowCurrentNavId = _Anonymous_50.ImGuiNavMoveFlags_AllowCurrentNavId;
    enum ImGuiNavMoveFlags_AlsoScoreVisibleSet = _Anonymous_50.ImGuiNavMoveFlags_AlsoScoreVisibleSet;
    enum ImGuiNavMoveFlags_ScrollToEdge = _Anonymous_50.ImGuiNavMoveFlags_ScrollToEdge;
    alias ImGuiNavForward = _Anonymous_51;
    enum _Anonymous_51
    {
    ...
    enum ImGuiNavForward_None = _Anonymous_51.ImGuiNavForward_None;
    enum ImGuiNavForward_ForwardQueued = _Anonymous_51.ImGuiNavForward_ForwardQueued;
    enum ImGuiNavForward_ForwardActive = _Anonymous_51.ImGuiNavForward_ForwardActive;
    alias ImGuiNavLayer = _Anonymous_52;
    enum _Anonymous_52
    {
    ...
    enum ImGuiNavLayer_Main = _Anonymous_52.ImGuiNavLayer_Main;
    enum ImGuiNavLayer_Menu = _Anonymous_52.ImGuiNavLayer_Menu;
    enum ImGuiNavLayer_COUNT = _Anonymous_52.ImGuiNavLayer_COUNT;
    alias ImGuiPopupPositionPolicy = _Anonymous_53;
    enum _Anonymous_53
    {
        ImGuiPopupPositionPolicy_Default = 0,
        ImGuiPopupPositionPolicy_ComboBox = 1,
    }
    enum ImGuiPopupPositionPolicy_Default = _Anonymous_53.ImGuiPopupPositionPolicy_Default;
    enum ImGuiPopupPositionPolicy_ComboBox = _Anonymous_53.ImGuiPopupPositionPolicy_ComboBox;
    alias ImGuiDataTypePrivate_ = _Anonymous_54;
    enum _Anonymous_54
    {
    ...
    enum ImGuiDataType_String = _Anonymous_54.ImGuiDataType_String;
    enum ImGuiDataType_Pointer = _Anonymous_54.ImGuiDataType_Pointer;
    enum ImGuiDataType_ID = _Anonymous_54.ImGuiDataType_ID;
    alias ImGuiNextWindowDataFlags_ = _Anonymous_55;
    enum _Anonymous_55
    {
    ...
    enum ImGuiNextWindowDataFlags_None = _Anonymous_55.ImGuiNextWindowDataFlags_None;
    enum ImGuiNextWindowDataFlags_HasPos = _Anonymous_55.ImGuiNextWindowDataFlags_HasPos;
    enum ImGuiNextWindowDataFlags_HasSize = _Anonymous_55.ImGuiNextWindowDataFlags_HasSize;
    enum ImGuiNextWindowDataFlags_HasContentSize = _Anonymous_55.ImGuiNextWindowDataFlags_HasContentSize;
    enum ImGuiNextWindowDataFlags_HasCollapsed = _Anonymous_55.ImGuiNextWindowDataFlags_HasCollapsed;
    enum ImGuiNextWindowDataFlags_HasSizeConstraint = _Anonymous_55.ImGuiNextWindowDataFlags_HasSizeConstraint;
    enum ImGuiNextWindowDataFlags_HasFocus = _Anonymous_55.ImGuiNextWindowDataFlags_HasFocus;
    enum ImGuiNextWindowDataFlags_HasBgAlpha = _Anonymous_55.ImGuiNextWindowDataFlags_HasBgAlpha;
    enum ImGuiNextWindowDataFlags_HasScroll = _Anonymous_55.ImGuiNextWindowDataFlags_HasScroll;
    alias ImGuiNextItemDataFlags_ = _Anonymous_56;
    enum _Anonymous_56
    {
    ...
    enum ImGuiNextItemDataFlags_None = _Anonymous_56.ImGuiNextItemDataFlags_None;
    enum ImGuiNextItemDataFlags_HasWidth = _Anonymous_56.ImGuiNextItemDataFlags_HasWidth;
    enum ImGuiNextItemDataFlags_HasOpen = _Anonymous_56.ImGuiNextItemDataFlags_HasOpen;
    alias ImGuiColumnsFlags_ = _Anonymous_57;
    enum _Anonymous_57
    {
    ...
    enum ImGuiColumnsFlags_None = _Anonymous_57.ImGuiColumnsFlags_None;
    enum ImGuiColumnsFlags_NoBorder = _Anonymous_57.ImGuiColumnsFlags_NoBorder;
    enum ImGuiColumnsFlags_NoResize = _Anonymous_57.ImGuiColumnsFlags_NoResize;
    enum ImGuiColumnsFlags_NoPreserveWidths = _Anonymous_57.ImGuiColumnsFlags_NoPreserveWidths;
    enum ImGuiColumnsFlags_NoForceWithinWindow = _Anonymous_57.ImGuiColumnsFlags_NoForceWithinWindow;
    enum ImGuiColumnsFlags_GrowParentContentsSize = _Anonymous_57.ImGuiColumnsFlags_GrowParentContentsSize;
    alias ImGuiTabBarFlagsPrivate_ = _Anonymous_58;
    enum _Anonymous_58
    {
    ...
    enum ImGuiTabBarFlags_DockNode = _Anonymous_58.ImGuiTabBarFlags_DockNode;
    enum ImGuiTabBarFlags_IsFocused = _Anonymous_58.ImGuiTabBarFlags_IsFocused;
    enum ImGuiTabBarFlags_SaveSettings = _Anonymous_58.ImGuiTabBarFlags_SaveSettings;
    alias ImGuiTabItemFlagsPrivate_ = _Anonymous_59;
    enum _Anonymous_59
    {
        ImGuiTabItemFlags_NoCloseButton = 1048576,
    }
    enum ImGuiTabItemFlags_NoCloseButton = _Anonymous_59.ImGuiTabItemFlags_NoCloseButton;
    ...
    static if(!is(typeof(P_tmpdir))) {
        private enum enumMixinStr_P_tmpdir = `enum P_tmpdir = _P_tmpdir;`;
        static if(is(typeof({ mixin(enumMixinStr_P_tmpdir); }))) {
            mixin(enumMixinStr_P_tmpdir);
        }
    }
    static if(!is(typeof(_SWPRINTFS_DEPRECATED))) {
        private enum enumMixinStr__SWPRINTFS_DEPRECATED = `enum _SWPRINTFS_DEPRECATED = _CRT_DEPRECATE_TEXT ( "swprintf has been changed to conform with the ISO C standard, adding an extra character count parameter. To use traditional Microsoft swprintf, set _CRT_NON_CONFORMING_SWPRINTFS." );`;
    ...
    static if(!is(typeof(TMP_MAX_S))) {
        private enum enumMixinStr_TMP_MAX_S = `enum TMP_MAX_S = 2147483647;`;
    ...
    static if(!is(typeof(L_tmpnam_s))) {
        private enum enumMixinStr_L_tmpnam_s = `enum L_tmpnam_s = ( ( _P_tmpdir ) .sizeof + 16 );`;
    ...
    static if(!is(typeof(L_tmpnam))) {
        private enum enumMixinStr_L_tmpnam = `enum L_tmpnam = ( ( _P_tmpdir ) .sizeof + 12 );`;
    ...
    static if(!is(typeof(__FILEW__))) {
        private enum enumMixinStr___FILEW__ = `enum __FILEW__ = _STR2WSTR ( "D:\\HipremeEngine\\building\\cimgui\\dpptest\\td.d.tmp" );`;
