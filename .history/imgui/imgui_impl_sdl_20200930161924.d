...
enum MAP_BUTTON_SDL(ImGuiIO* io, ulong NAV_NO, SDL_GameControllerButton BUTTON_NO)
{
    io.NavInputs[NAV_NO] = (SDL_GameControllerGetButton(game_controller, BUTTON_NO) != 0) ? 1.0f : 0.0f;
}
enum MAP_ANALOG_SDL(ImGuiIO* io, ulong NAV_NO, SDL_GameControllerAxis AXIS_NO, int V0, int V1)
{
...
static void ImGui_ImplSDL2_UpdateMousePosAndButtons()
{
    ...
    if (io.WantSetMousePos)
        ...
        io.MousePos = ImVec2(-igGetFLT_MAX(), -igGetFLT_MAX());
...
{
    ImGuiIO* io = igGetIO();
    memset(io.NavInputs, 0, io.NavInputs.sizeof);
