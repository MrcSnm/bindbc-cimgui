...
enum MAP_BUTTON_SDL(ImGuiIO* io,SDL_GameController* game_controller, uint NAV_NO, SDL_GameControllerButton BUTTON_NO)
{
    io.NavInputs[NAV_NO] = (SDL_GameControllerGetButton(game_controller, BUTTON_NO) != 0) ? 1.0f : 0.0f;
}
enum MAP_ANALOG_SDL(ImGuiIO* io, SDL_GameController* game_controller, uint NAV_NO, SDL_GameControllerAxis AXIS_NO, int V0, int V1)
{
