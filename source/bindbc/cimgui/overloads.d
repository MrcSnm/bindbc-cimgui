...
ImColor ImColor(const ImVec4& col){ImColor_ImColorVec4(col);}
void AddText(const ImVec2& pos,ImU32 col,const char* text_begin,const char* text_end=((void*)0)){ImDrawList_AddTextVec2(self,pos,col,text_begin,text_end);}
void AddText(const ImFont* font,float font_size,const ImVec2& pos,ImU32 col,const char* text_begin,const char* text_end=((void*)0),float wrap_width=0.0f,const ImVec4* cpu_fine_clip_rect=((void*)0)){ImDrawList_AddTextFontPtr(self,font,font_size,pos,col,text_begin,text_end,wrap_width,cpu_fine_clip_rect);}
...
ImGuiID GetID(const char* str,const char* str_end=((void*)0)){ImGuiWindow_GetIDStr(self,str,str_end);}
ImGuiID GetID(const void* ptr){ImGuiWindow_GetIDPtr(self,ptr);}
ImGuiID GetID(int n){ImGuiWindow_GetIDInt(self,n);}
ImGuiID GetIDNoKeepAlive(const char* str,const char* str_end=((void*)0)){ImGuiWindow_GetIDNoKeepAliveStr(self,str,str_end);}
...
void Add(const ImVec2& p){ImRect_AddVec2(self,p);}
void Add(const ImRect& r){ImRect_AddRect(self,r);}
bool Contains(const ImVec2& p){ImRect_ContainsVec2(self,p);}
bool Contains(const ImRect& r){ImRect_ContainsRect(self,r);}
void Expand(const float amount){ImRect_ExpandFloat(self,amount);}
void Expand(const ImVec2& amount){ImRect_ExpandVec2(self,amount);}
ImRect ImRect(){ImRect_ImRectNil();}
ImRect ImRect(const ImVec2& min,const ImVec2& max){ImRect_ImRectVec2(min,max);}
ImRect ImRect(const ImVec4& v){ImRect_ImRectVec4(v);}
...
ImVec2ih ImVec2ih(const ImVec2& rhs){ImVec2ih_ImVec2ihVec2(rhs);}
ImVec4 ImVec4(){ImVec4_ImVec4Nil();}
ImVec4 ImVec4(float _x,float _y,float _z,float _w){ImVec4_ImVec4Float(_x,_y,_z,_w);}
bool igBeginChild(const char* str_id,const ImVec2& size=ImVec2(0,0),bool border=false,ImGuiWindowFlags flags=0){igBeginChildStr(str_id,size,border,flags);}
bool igBeginChild(ImGuiID id,const ImVec2& size=ImVec2(0,0),bool border=false,ImGuiWindowFlags flags=0){igBeginChildID(id,size,border,flags);}
...
bool igCombo(const char* label,int* current_item,const char* const items[],int items_count,int popup_max_height_in_items=-1){igComboStr_arr(label,current_item,items,items_count,popup_max_height_in_items);}
...
bool igCombo(const char* label,int* current_item,bool(*items_getter)(void* data,int idx,const char** out_text),void* data,int items_count,int popup_max_height_in_items=-1){igComboFnBoolPtr(label,current_item,items_getter,data,items_count,popup_max_height_in_items);}
...
ImU32 igGetColorU32(const ImVec4& col){igGetColorU32Vec4(col);}
...
ImVec2 igImFloor(const ImVec2& v){igImFloorVec2(pOut,v);}
float igImLengthSqr(const ImVec2& lhs){igImLengthSqrVec2(lhs);}
float igImLengthSqr(const ImVec4& lhs){igImLengthSqrVec4(lhs);}
ImVec2 igImLerp(const ImVec2& a,const ImVec2& b,float t){igImLerpVec2Float(pOut,a,b,t);}
ImVec2 igImLerp(const ImVec2& a,const ImVec2& b,const ImVec2& t){igImLerpVec2Vec2(pOut,a,b,t);}
ImVec4 igImLerp(const ImVec4& a,const ImVec4& b,float t){igImLerpVec4(pOut,a,b,t);}
...
bool igIsRectVisible(const ImVec2& size){igIsRectVisibleNil(size);}
bool igIsRectVisible(const ImVec2& rect_min,const ImVec2& rect_max){igIsRectVisibleVec2(rect_min,rect_max);}
void igItemSize(const ImVec2& size,float text_baseline_y=-1.0f){igItemSizeVec2(size,text_baseline_y);}
void igItemSize(const ImRect& bb,float text_baseline_y=-1.0f){igItemSizeRect(bb,text_baseline_y);}
bool igListBox(const char* label,int* current_item,const char* const items[],int items_count,int height_in_items=-1){igListBoxStr_arr(label,current_item,items,items_count,height_in_items);}
bool igListBox(const char* label,int* current_item,bool(*items_getter)(void* data,int idx,const char** out_text),void* data,int items_count,int height_in_items=-1){igListBoxFnBoolPtr(label,current_item,items_getter,data,items_count,height_in_items);}
bool igListBoxHeader(const char* label,const ImVec2& size=ImVec2(0,0)){igListBoxHeaderVec2(label,size);}
...
bool igMenuItem(const char* label,const char* shortcut=((void*)0),bool selected=false,bool enabled=true){igMenuItemBool(label,shortcut,selected,enabled);}
...
void igPlotHistogram(const char* label,const float* values,int values_count,int values_offset=0,const char* overlay_text=((void*)0),float scale_min=3.40282346638528859811704183484516925e+38F,float scale_max=3.40282346638528859811704183484516925e+38F,ImVec2 graph_size=ImVec2(0,0),int stride=sizeof(float)){igPlotHistogramFloatPtr(label,values,values_count,values_offset,overlay_text,scale_min,scale_max,graph_size,stride);}
void igPlotHistogram(const char* label,float(*values_getter)(void* data,int idx),void* data,int values_count,int values_offset=0,const char* overlay_text=((void*)0),float scale_min=3.40282346638528859811704183484516925e+38F,float scale_max=3.40282346638528859811704183484516925e+38F,ImVec2 graph_size=ImVec2(0,0)){igPlotHistogramFnFloatPtr(label,values_getter,data,values_count,values_offset,overlay_text,scale_min,scale_max,graph_size);}
void igPlotLines(const char* label,const float* values,int values_count,int values_offset=0,const char* overlay_text=((void*)0),float scale_min=3.40282346638528859811704183484516925e+38F,float scale_max=3.40282346638528859811704183484516925e+38F,ImVec2 graph_size=ImVec2(0,0),int stride=sizeof(float)){igPlotLinesFloatPtr(label,values,values_count,values_offset,overlay_text,scale_min,scale_max,graph_size,stride);}
void igPlotLines(const char* label,float(*values_getter)(void* data,int idx),void* data,int values_count,int values_offset=0,const char* overlay_text=((void*)0),float scale_min=3.40282346638528859811704183484516925e+38F,float scale_max=3.40282346638528859811704183484516925e+38F,ImVec2 graph_size=ImVec2(0,0)){igPlotLinesFnFloatPtr(label,values_getter,data,values_count,values_offset,overlay_text,scale_min,scale_max,graph_size);}
...
bool igSelectable(const char* label,bool selected=false,ImGuiSelectableFlags flags=0,const ImVec2& size=ImVec2(0,0)){igSelectableBool(label,selected,flags,size);}
bool igSelectable(const char* label,bool* p_selected,ImGuiSelectableFlags flags=0,const ImVec2& size=ImVec2(0,0)){igSelectableBoolPtr(label,p_selected,flags,size);}
...
void igSetWindowPos(const ImVec2& pos,ImGuiCond cond=0){igSetWindowPosVec2(pos,cond);}
void igSetWindowPos(const char* name,const ImVec2& pos,ImGuiCond cond=0){igSetWindowPosStr(name,pos,cond);}
void igSetWindowPos(ImGuiWindow* window,const ImVec2& pos,ImGuiCond cond=0){igSetWindowPosWindowPtr(window,pos,cond);}
void igSetWindowSize(const ImVec2& size,ImGuiCond cond=0){igSetWindowSizeVec2(size,cond);}
void igSetWindowSize(const char* name,const ImVec2& size,ImGuiCond cond=0){igSetWindowSizeStr(name,size,cond);}
void igSetWindowSize(ImGuiWindow* window,const ImVec2& size,ImGuiCond cond=0){igSetWindowSizeWindowPtr(window,size,cond);}
/**
...
void igTreePush(const void* ptr_id=((void*)0)){igTreePushPtr(ptr_id);}
void igValue(const char* prefix,bool b){igValueBool(prefix,b);}
void igValue(const char* prefix,int v){igValueInt(prefix,v);}
void igValue(const char* prefix,unsigned int v){igValueUint(prefix,v);}
void igValue(const char* prefix,float v,const char* float_format=((void*)0)){igValueFloat(prefix,v,float_format);}
